...
function useCommittedRef(value) {
  var ref = (0, import_react10.useRef)(value);
...
var ToastContext = React8.createContext({
  onClose() {
  }
});
...
var ToastHeader = React9.forwardRef(({
  bsPrefix,
  closeLabel,
  closeVariant,
  closeButton,
  ...
  const context = (0, import_react13.useContext)(ToastContext_default);
...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = React10.forwardRef(({
    className,
    bsPrefix,
  ...
  BsComponent.defaultProps = defaultProps4;
...
var Toast = React11.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime9.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime9.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime9.jsx)(Transition2, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
*/
//# sourceMappingURL=chunk-6UQ2FDNK.js.map
